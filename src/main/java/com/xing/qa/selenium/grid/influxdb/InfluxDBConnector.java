...
public class InfluxDBConnector {
    ...
    public static final String DATABASE = envOr("IFXDB_DB", "selenium-grid");

    public static final String URL = format("http://%s:%s", envOr("IFXDB_HOST", "localhost"), envOr("IFXDB_PORT", "8086"));
